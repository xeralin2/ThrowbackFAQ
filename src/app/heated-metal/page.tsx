  ...
  return (
    <>
      ...
      <div className="mb-8">
        ...
        <OnDownloader>
          <LinkButton href="https://github.com/DataCluster0/HeatedMetal/releases/latest">
            Download
          </LinkButton>
        </OnDownloader>
        <LinkButton href="https://discord.gg/7mR9VxBxWd" secondary>
          Discord
        </LinkButton>
      </div>
      ...
      <Prose>
        ...
        <OnDownloader>
          <OnWindows>
            <ol>
              <li>
                Run <code>HeatedMetal.bat</code> from the downloader folder
              </li>
              <li>
