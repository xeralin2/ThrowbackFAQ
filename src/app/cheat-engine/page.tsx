...
import { OnDownloader, OnLinux, OnWindows } from "@/components/OnPlatform";
    ...
    <>
      ...
      <OnWindows>
        <Callout label="// NOTE">
          ...
          the <Link href="/antivirus">Antivirus</Link> page for details.
        </Callout>
      </OnWindows>
      ...
      <Prose>
        ...
        <OnLinux>
          <ol>
            ...
            <li>
              In the launcher, open this page in the FAQ and press{" "}
        ...
        <OnDownloader>
          <p className="note">
            The <code>tools</code> entry requires the current ThrowbackLoader —
            if <code>Config.toml</code> is missing from your season folder,
            replace the crack files first as described on the{" "}
            <Link href="/downloaders">Downloaders page</Link>.
          </p>
        </OnDownloader>
      </Prose>
