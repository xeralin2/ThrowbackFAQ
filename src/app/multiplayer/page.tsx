    ...
    a: (
      <ol>
        <li>
          ...
          same build, which downloading the same season and build guarantees,
          and which <strong>Show Metrics</strong> in the game settings confirms
          in game
        </li>
        <li>
      ...
      <Prose>
        <ol>
          ...
          <OnLinux>
            ...
            <li>
              Open <strong>Extra</strong> in the launcher Settings, select the
